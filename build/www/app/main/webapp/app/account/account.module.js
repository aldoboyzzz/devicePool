...
var _1 = require("./");
var DevicePoolAccountModule = /** @class */ (function () {
    function DevicePoolAccountModule() {
    }
    DevicePoolAccountModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    ], DevicePoolAccountModule);
    return DevicePoolAccountModule;
}());
exports.DevicePoolAccountModule = DevicePoolAccountModule;
