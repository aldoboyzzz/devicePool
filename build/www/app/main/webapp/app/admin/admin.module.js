...
var _1 = require("./");
var DevicePoolAdminModule = /** @class */ (function () {
    function DevicePoolAdminModule() {
    }
    DevicePoolAdminModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return DevicePoolAdminModule;
}());
exports.DevicePoolAdminModule = DevicePoolAdminModule;
