...
var DevicePoolSharedLibsModule = /** @class */ (function () {
    function DevicePoolSharedLibsModule() {
    }
    DevicePoolSharedLibsModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return DevicePoolSharedLibsModule;
}());
exports.DevicePoolSharedLibsModule = DevicePoolSharedLibsModule;
